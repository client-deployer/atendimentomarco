<?php 
$r1=1;$r2=2;$r3=3;$r4=4;
function graficoconsolidadovendas($array){
    $array = json_decode($array);
    $totals = array(1 => 0, 2 => 0, 3 => 0, 4 => 0);
	$devolucoes=array(1 => 0, 2 => 0, 3 => 0, 4 => 0);
    foreach($array as $soma){
        if (isset($totals[$soma->revenda])) {
            $totals[$soma->revenda] += ($soma->total_bruto-$soma->descontos);
			$devolucoes[$soma->revenda] +=($soma->devolucoes);
		}
    }
      return [
    'totals' => $totals,
