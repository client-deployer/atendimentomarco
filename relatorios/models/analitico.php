...
require 'functions.php';?>
 ...
 global $datafim ;
  ...
  $url = "http://10.15.32.11:8000/vendaanalitico/1/".str_replace("/","-",$datainicio)."/".str_replace("/","-",$datafim)."";
      //     var_dump($url);
...
<div class="m-5"><h1>VENDA ANÁLITICO</h1> 
...
<?php
$table = $relatorio->tableanalitico($dados);
  ?>
