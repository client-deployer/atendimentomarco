  ...
  <div class="flex">
    ...
    <div class="hidden lg:flex min-w-[200px] bg-[#333333] min-h-screen px-6 py-3 gap-8 flex flex-col self-start">
      ...
      <div class="flex flex-col gap-4">
        ...
        <input name='nota' style="width: 9rem;" type="file" class="bg-[#367362] rounded-md py-3 px-2 text-white rounded-md hover:scale-105 transition-all ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-[#367362] transition-all disabled:opacity-50 disabled:hover:bg-[#367362]"/>
      ...
      <div class="mt-6 mx-4">
        ...
        <table class="w-full rounded-md text-center">
          <tr class="bg-[#5a5a5a]">
            ...
            <th class="border-2 border-[#333333] font-normal py-4 text-[#efefef]">Usuario(ENVIO)</th>
            <th class="border-2 border-[#333333] font-normal py-4 text-[#efefef]">OBS</th>
          </tr>
          <tr>
            <?php
            require 'notaslancadas.php';
            ?>
          </tr>
        </table>
      </div>
